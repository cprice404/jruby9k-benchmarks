...
public class TimeParseBenchmarkDriver {
    public static void main(final String[] args) throws IOException {
        ...
        System.out.println("Opening maven_timeparse_benchmark_output.txt, setting as JRuby stdout.");
        Writer writer = new FileWriter("./maven_timeparse_benchmark_output.txt", true);
        ...
        sc.runScriptlet(PathType.RELATIVE, "./timeparse_benchmark.rb");
        sc.terminate();
        writer.close();
    }
}
