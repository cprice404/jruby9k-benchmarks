...
import net.bull.javamelody.PublicHeapHistogram;
...
public class ByteCodeMachineLeak {
    ...
    public static void fooHeapHisto() throws Exception {
        Map<String, PublicHeapHistogram.PublicClassInfo> cs = PublicHeapHistogram.publicHeapHistoMap();
        for (String className : cs.keySet()) {
            System.out.println("Class '" + className + "'; num instances: " + cs.get(className).getInstancesCount());
        }
    }
    ...
    public static void main(final String[] args) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            sc.runScriptlet(IOUtils.toString(new FileInputStream("./byte_code_machine_leak.rb"), "UTF-8"));
            sc.terminate();
